                    ...
                    <div id="block-2" class="widget chromenews-widget widget_block widget_search">
                        <form role="search" method="get"
                            ...
                            <label class="wp-block-search__label screen-reader-text"
                                for="wp-block-search__input-1">Cari</label>
                            <div class="wp-block-search__inside-wrapper ">
                                <input class="wp-block-search__input" id="wp-block-search__input-1"
                                    placeholder="Cari policy brief" value="" type="search" name="search" required />
                                <button aria-label="Cari" class="wp-block-search__button has-icon wp-element-button"
                                    type="submit">
                                                ...
                                                <div class="panel">
                                                    <ul>
                                                        @foreach ($subject->indicators as $indicator)
                                                            <li>
                                                                <a
                                                                    href="{{ url($currentMenu->url) }}?indicator_id={{ $indicator->id }}">
                                                                    {{ $indicator->name }}
                                                                </a>
                                                            </li>
                                                        @endforeach
                                        ...
                                        <div class="af-container-row clearfix" style="margin-bottom: 20px">
                                            @foreach ($row as $policyBrief)
                                                <div class="col-4 pad float-l trending-posts-item">
                                                    <a class="infographic"
                                                        href="{{ asset('storage/' . $policyBrief->file_path) }}"
                                                        target="_blank">
