          ...
          <div id="block-2" class="widget chromenews-widget widget_block widget_search">
            <form role="search" method="get"
              ...
              <div class="wp-block-search__inside-wrapper ">
                <input class="wp-block-search__input" id="wp-block-search__input-1" placeholder="Cari infografis"
                    ...
                    <div class="af-container-row clearfix" style="margin-bottom: 20px">
                      @foreach ($row as $infographic)
                        <div class="col-4 pad float-l trending-posts-item">
                          <a class="infographic" href="{{ asset('storage/' . $infographic->image) }}">
                            <img class="infographic__thumbnail" loading="lazy" decoding="async"
                              src="{{ asset('storage/' . $infographic->image) }}" alt="{{ $infographic->title }}" />
