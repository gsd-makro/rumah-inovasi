  ...
  <div class="mobile-sticky fs-6 bg-secondary">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark px-0 py-0">
        ...
        <!-- Mobile logo -->
        <a href="https://demo.bootstrap.news/default/">
          <img class="mobile-logo img-fluid d-lg-none mx-auto" alt="mobile logo"
        ...
        <div id="navbarTogglerDemo" class="collapse navbar-collapse">
          ...
          <div class="date-area d-none d-lg-block">
            {{-- <time class="navbar-text me-2" datetime="2024-11-03">Sunday, November 3, 2024</time> --}}
            <time class="navbar-text me-2" datetime="{{ now()->format('Y-m-d') }}">
              {{ now()->format('l, F j, Y') }}
            </time>
          </div>
          <!--Top start menu-->
      ...
      <div class="collapse navbar-collapse col-12 py-2" id="navbarTogglerDemo2">
        <!--search form-->
        <form class="form-inline" method="get" action="https://demo.bootstrap.news/default/" role="search">
          <div class="input-group w-100">
            <input class="form-control border border-right-0" name="s" type="text"
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <div id="main-logo" class="main-logo my-2 my-lg-4 d-none d-lg-block text-center-md-down">
            <a href="https://demo.bootstrap.news/default/" class="navbar-brand custom-logo-link" rel="home">
              <img width="452" height="95" src="{{ asset('/img/logo-bootnews.png') }}" class="img-fluid"
                alt="logo-bootnews"
                srcset="
