...
<body>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo mt-4">
                            <p class="fs-5 text-primary">Rinov Go</p>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Jumlah Infografis</h4>
                                    </div>
                                    <div class="card-body">
                                        <canvas id="infografisChart" width="800" height="500"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="fotoChart" width="800" height="500"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="videoChart" width="800" height="500"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="dokumenChart" width="800" height="500"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const dataCharts = @json($dataCharts);

            const labels = dataCharts.infographics.map(item => item.date);
            ...
            function createChart(canvasId, data, label, color) {
                ...
                return new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: label,
                            data: data.map(item => item.aggregate),
            ...
            createChart('infografisChart', dataCharts.infographics, 'Infografis', 'rgba(75, 192, 192, 0.8)');
            createChart('fotoChart', dataCharts.photos, 'Foto', 'rgba(255, 99, 132, 0.8)');
            createChart('videoChart', dataCharts.videos, 'Video', 'rgba(54, 162, 235, 0.8)');
            createChart('dokumenChart', dataCharts.documents, 'Dokumen', 'rgba(153, 102, 255, 0.8)');
        });
    </script>
</body>
